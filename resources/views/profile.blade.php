...
@section('content')
    ...
    <style>
        ...
        * {
        ...
        .profile-toast .toast-close:hover {
            opacity: 1;
        }
                            ...
                            <div class="avatar-card-body">
                                <div class="avatar-wrap">
                                    ...
                                    @else
                                        ...
                                        <img src="" alt="" class="avatar-img" id="avatarPreview"
                                            style="display:none;">
                                    @endif
                                ...
                                <div class="profile-name">{{ Auth::user()->first_name ?? (Auth::user()->name ?? 'User') }}
                                ...
                                <button type="submit" class="btn-save" id="avatarSaveBtn"
                    ...
                    <div class="profile-card">
                            ...
                            <form action="{{ route('profile.update') }}" method="POST">
                                ...
                                <div class="form-row">
                                    <div class="field-group">
                                        <label class="field-label" for="first_name">First Name <span
                                ...
                                <div class="form-row full">
                                    <div class="field-group">
                                        <label class="field-label" for="email">Email Address <span
                                                class="req">*</span></label>
                                        <input type="email" id="email" name="email" class="field-input"
                                            value="{{ Auth::user()->email }}" placeholder="your@email.com" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="field-group">
                                        ...
                                        <input type="tel" id="phone" name="phone" class="field-input"
                                            value="{{ Auth::user()->phone ?? '' }}" placeholder="+91 99999 00000">
                                    </div>
                                    <div class="field-group">
                                ...
                                <div class="form-row full">
                                    <div class="field-group">
                                        ...
                                        <textarea id="bio" name="bio" class="field-input" rows="3"
                                            placeholder="Write a short bio about yourself..." maxlength="300" oninput="bioCount(this)">{{ Auth::user()->bio ?? '' }}</textarea>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="field-group">
                                        ...
                                        <input type="text" id="role_display" class="field-input"
                                            value="{{ Auth::user()->role->name ?? 'No Role Assigned' }}" disabled>
                                ...
                                <div class="form-footer">
                                    ...
                                    <button type="reset" class="btn-reset">
                                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path d="M3.51 15a9 9 0 1 0 .49-4.31" />
                                        </svg>
                                        Reset
                                    </button>
                                </div>
                        ...
                        <div class="tab-content" id="tab-password">
                            <form action="{{ route('profile.password') }}" method="POST">
                                ...
                                <div class="form-row full" style="margin-bottom:1.1rem;">
                                    <div class="field-group">
                                        <label class="field-label" for="current_password">Current Password <span
                                                class="req">*</span></label>
                                ...
                                <div class="form-row full" style="margin-bottom:1.1rem;">
                                    <div class="field-group">
                                        <label class="field-label" for="new_password">New Password <span
                                                class="req">*</span></label>
                                        <div class="input-eye-wrap">
                                ...
                                <div class="form-row full" style="margin-bottom:1.1rem;">
                                    <div class="field-group">
                                        <label class="field-label" for="new_password_confirmation">Confirm New Password
                                            <span class="req">*</span></label>
                                        <div class="input-eye-wrap">
                                            <input type="password" id="new_password_confirmation"
                                                name="new_password_confirmation" class="field-input"
                                                placeholder="Repeat new password" required oninput="checkMatch(this)">
                                            <button type="button" class="eye-toggle"
                                                onclick="togglePass('new_password_confirmation', this)">
                                                <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2">
                                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
                                                    <circle cx="12" cy="12" r="3" />
                        ...
                        <div class="tab-content" id="tab-danger">
                            ...
                            <div style="display:flex; flex-direction:column; gap:0.9rem;">
                                ...
                                {{-- Deactivate --}}
                                <form id="deactivateForm" action="{{ route('profile.deactivate') }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="danger-zone">
                                        <div class="danger-zone-info">
                                            <h4>Deactivate Account</h4>
                                            <p>Temporarily disable your account. You can reactivate it by logging in again.
                                            </p>
                                        </div>
                                </form>
    ...
    <div id="deleteModal"
        ...
        <div
            style="background:#1a1a2a; border:1px solid #252538; border-radius:16px; padding:2rem; max-width:400px; width:90%; text-align:center;">
            <div
                style="width:56px;height:56px;background:rgba(255,79,107,0.12);border-radius:14px;margin:0 auto 1.2rem;display:flex;align-items:center;justify-content:center;">
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#ff4f6b"
                    stroke-width="2">
            ...
            <h3 style="font-family:'Syne',sans-serif;font-size:1.1rem;color:#fff;margin-bottom:0.5rem;">Delete Your
                Account?</h3>
            <p style="font-size:0.82rem;color:#6b6b8a;margin-bottom:1rem;line-height:1.6;">This will permanently delete
                your account, posts, and all data. Type <strong style="color:#ff4f6b;">DELETE</strong> to confirm.</p>
            ...
            <div style="display:flex;gap:0.75rem;justify-content:center;">
                <button onclick="closeDeleteModal()"
                    style="padding:0.65rem 1.4rem;background:transparent;border:1px solid #252538;color:#6b6b8a;border-radius:8px;font-family:'Karla',sans-serif;font-size:0.85rem;cursor:pointer;">Cancel</button>
