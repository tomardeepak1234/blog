    @extends('admin.admin_meta')
        ...
        <style>
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .field-group:nth-child(5) { animation-delay: 0.44s; }
            ...
            input[type="datetime-local"].field-input::-webkit-calendar-picker-indicator:hover {
                opacity: 1;
            }
            ...
            .schedule-info.show { display: flex; }
            .schedule-info-icon {
            ...
            <div class="post-card">
                ...
                <div class="post-card-body">
                    ...
                    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data" id="postForm">
                        ...
                        {{-- Status --}}
                        <div class="field-group">
                            <label class="field-label" for="is_published">
                                Post Status <span class="req">*</span>
                            </label>
                            <select
                                id="is_published"
                                name="is_published"
                                class="field-input {{ $errors->has('is_published') ? 'is-invalid' : '' }}"
                                required
                            ...
                            >
                                <option value="" disabled {{ old('is_published') === null ? 'selected' : '' }}>— Select status —</option>
                                <option value="1" {{ old('is_published') == '1' ? 'selected' : '' }}>✅ Published</option>
                                <option value="0" {{ old('is_published') == '0' ? 'selected' : '' }}>🚫 Unpublished (Draft)</option>
                            </select>
                            @error('is_published')
                            <div class="field-error">
                                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                        ...
                        <div class="field-group">
                            ...
                            <div class="schedule-info" id="scheduleInfo">
                                <div class="schedule-info-icon">
                                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#a78bfa" stroke-width="2.5"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                                </div>
                                <span class="schedule-info-text" id="scheduleInfoText">Post will be scheduled</span>
                            </div>
                            <div class="field-footer">
                                <span class="char-count">Leave empty to publish immediately</span>
                            </div>
                        </div>
        ...
        <script>
            ...
            function scheduleUpdate(input) {
                ...
                if (input.value) {
                    ...
                    infoText.textContent = `Scheduled for ${formatted}`;
